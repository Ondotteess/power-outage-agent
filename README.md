...
Demo-runner пересобирает демо-реестр из 50 офисов по Кемеровской, Новосибирской и Томской областям, берёт по 13 локальных demo-записей на каждый активный источник (10 «чистых» адресов + 3 «грязных» варианта с сокращениями `ул.` / `пр-т` / `г.`, проверяющие, что канонический ключ адреса склеивает их с «чистыми» дубликатами) и прогоняет
