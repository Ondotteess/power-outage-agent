...
Не реализовано: Alembic-миграции, persistent queue-depth time series, лог-стрим из БД/observability-системы.
...
Текущий счётчик: 123 pytest-кейса, все зелёные.
