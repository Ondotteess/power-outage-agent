...
const OFFICE_IMPACTS: OfficeImpact[] = [
  {
    ...
    match_score: 1,
    match_explanation: ["city_score=1.00", "street_score=1.00", "building exact"],
  ...
  },
  {
    ...
    impact_level: "medium",
    match_strategy: "house_range",
    match_score: 0.92,
    match_explanation: ["city_score=1.00", "street_score=1.00", "house covered by range"],
    ...
    active_impacts: [
      {
        ...
        event_type: "power_outage",
        match_strategy: OFFICE_IMPACTS[0].match_strategy,
        match_score: OFFICE_IMPACTS[0].match_score ?? null,
        match_explanation: OFFICE_IMPACTS[0].match_explanation,
        source_name: "Россети Сибирь — плановые отключения",
        source_url: "https://www.rosseti-sib.ru/local/templates/rosseti/components/is/proxy/shutdown_schedule_table/data.php",
        source_record_url: "https://www.rosseti-sib.ru/local/templates/rosseti/components/is/proxy/shutdown_schedule_table/data.php",
        source_record_id: "mock-1001",
        raw_record_id: RAW[0]?.id ?? null,
        parsed_record_id: PARSED[0]?.id ?? null,
        fetched_at: RAW[0]?.fetched_at ?? null,
      },
    ],
  },
  {
    ...
    active_impacts: [
      {
        ...
        match_strategy: OFFICE_IMPACTS[1].match_strategy,
        match_score: OFFICE_IMPACTS[1].match_score ?? null,
        match_explanation: OFFICE_IMPACTS[1].match_explanation,
        source_name: "Россети Томск — плановые отключения",
        source_url: "https://rosseti-tomsk.ru/customers/info_disconections/planovie_otklucheniya.php",
        source_record_url: "https://rosseti-tomsk.ru/customers/info_disconections/planovie_otklucheniya.php#mock-row-2",
        source_record_id: "mock-row-2",
        raw_record_id: RAW[2]?.id ?? null,
        parsed_record_id: PARSED[2]?.id ?? null,
        fetched_at: RAW[2]?.fetched_at ?? null,
      },
    ],
  },
  {
